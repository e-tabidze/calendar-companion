...
const NewProductSchema = Yup.object().shape({
  ...
  images: Yup.array().of(Yup.string()).min(4, 'გთხოვთ, ატვირთოთ ავტომობილის ფოტოები, მინიმუმ 4, მაქსიმუმ 15').max(15, 'ავტომობილის ფოტოების მაქსიმალური რაოდენობა არის 15'),
