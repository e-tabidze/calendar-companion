...
const NewProductSchema = Yup.object().shape({
  vin: Yup.string().required().max(17, 'max_symbol_length_17'),
  ...
  additional_information_en: Yup.string().required('required_field').typeError('required_field'),
  use_instruction: Yup.string().required('required_field').typeError('required_field'),
  use_instruction_en: Yup.string().required('required_field').typeError('required_field'),
