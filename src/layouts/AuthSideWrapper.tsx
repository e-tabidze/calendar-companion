        ...
        <div className='rounded-3xl bg-[#00000042] p-8 pr-10 backdrop-blur-2xl'>
          ...
          <div className='flex flex-col gap-8 text-base font-medium text-white mt-10'>
            <div className='flex items-center gap-4'>
              ...
              <div> Upload and share files easily</div>
            </div>

            <div className='flex items-center gap-4'>
              <Icon svgPath='video' width={24} height={24} className='fill-yellow-100' />
              <div>Automatically record, transcribe and store the meetings</div>
            </div>

            <div className='flex items-center gap-4'>
              <Icon svgPath='messages' width={24} height={24} className='fill-yellow-100' />
              <div>Automatically record, transcribe and store the meetings</div>
            </div>

            <div className='flex items-center gap-4'>
              <Icon svgPath='calendarEdit' width={24} height={24} className='fill-yellow-100' />
              <div> Manage your schedule or view your teammates' scheduled meetings</div>
            </div>

            <div className='flex items-center gap-4'>
              <Icon svgPath='documentText' width={24} height={24} className='fill-yellow-100' />
              <div>Use a common document for the group, work together around the project</div>
            </div>
          </div>
        </div>
      </div>
