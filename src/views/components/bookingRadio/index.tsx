                                            ...
                                            <div className="pl-[52px] mt-[16px]">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="w-6/12">
                                                        <Typography type='body' className="text-[14px] ml-[40px]">თბილისი, იაკობ წურტაველის 72</Typography>
                                                    </div>
                                                    <div className="w-4/12 flex justify-between">
                                                        ...
                                                        <button onClick={toggleEditModal}
                                                                className="ml-[16px] border border-black flex items-center justify-center h-[48px] rounded-[12px] text-[12px] px-[24px]">შეცვლა</button>
                                                    </div>
                                                </div>
