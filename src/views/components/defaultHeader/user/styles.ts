...
export const RentBtn = tw.button<TailwindComponent>`flex h-10 bg-orange-10 hover:bg-orange-20 rounded-xl items-center px-4 xl:px-6 font-medium orangr-100 text-sm mr-4 transition-all`
