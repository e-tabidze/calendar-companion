...
export const RentBtn = tw.button<TailwindComponent>`flex h-10 bg-orange-10 hover:bg-orange-20 rounded-xl items-center px-3 lg:px-4 xl:px-6 font-medium text-sm mr-2 lg:mr-4 transition-all`
