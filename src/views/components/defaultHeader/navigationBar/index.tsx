...
const NavigationBar = () => {
    ...
    console.log(router.asPath, 'dfrsfws')
    ...
    return (
        <div className="lg:hidden bg-white py-4 fixed bottom-0 left-0 w-full z-[111] box-shadow-sm">
            <ul className="flex justify-around">
                    ...
                    <Link href={`${activeCompany?'/dashboard/dashboard':'/'}`}>
                        <div className="flex flex-col items-center text-[10px]">
                            <span className={`flex ${router.pathname == '/dashboard/dashboard/' ?'text-orange-100':''}`}>
                              <Icon svgPath='home' width={24} height={24} className={`${router.pathname.includes('/dashboard/dashboard/') ?'fill-orange-100':'fill-raisin-100'}`} />
                            </span>
                    ...
                    <li>
                        <Link href={`${isAuthenticated ?'/profile/favourites/': TNET_AUTH }`}>
                            <div className="flex flex-col items-center text-raisin-70">
                                    <span className="flex">
                                        <Icon svgPath='favorite' width={24} height={24} className={`${router.pathname.includes('/profile/favourites/')?'fill-orange-100':'fill-raisin-100'}`}/>
                                    </span>
                ...
                <li>
                    <Link href={isAuthenticated ? !!activeCompany ? '/dashboard/notifications/' : '/profile/notifications/' : TNET_AUTH}>
                            <div className="flex flex-col items-center text-raisin-70">
                            <span className="flex">
                                <Icon svgPath='bell' width={24} height={24} className={`${router.pathname.includes('/notifications/')?'fill-orange-100':'fill-raisin-100'}`} />
                            </span>
