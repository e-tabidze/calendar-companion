                    ...
                    {user == 0 &&
                        <>
                            ...
                            <div className="flex flex-col ">
                                ...
                                <span className="flex text-[14px] text-[#272A37]">
                                   ID: 146797
                                </span>
                            </div>
                        </div>
                            <ul className="py-[8px] border-b-1 border-raisin-10">
                                <li><a href="#"
                                       className="px-[24px] flex whitespace-nowrap text-[16px] text-[#272A37] py-[8px] hover:bg-[#F2F3F6] transition-all">ჩემი
                                    შეკვეთები</a></li>
                                <li><a href="#"
                                       className="px-[24px] flex whitespace-nowrap text-[16px] text-[#272A37] py-[8px] hover:bg-[#F2F3F6] transition-all">ბარათები
                                    და ტრანზაქციები</a></li>
                                <li><a href="#"
                                       className="px-[24px] flex items justify-between whitespace-nowrap text-[16px] text-[#272A37] py-[8px] hover:bg-[#F2F3F6] transition-all"><span> პარამეტრები</span></a>
                                </li>
                                <li><a href="#"
                                       className="px-[24px] flex whitespace-nowrap text-[16px] text-[#272A37] py-[8px] hover:bg-[#F2F3F6] transition-all">კომპანიის
                                    შექმნა</a></li>
                            </ul>
                        </>
                    }
