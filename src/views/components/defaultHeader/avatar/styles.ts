...
export const AvatarContainer = tw.div<TailwindComponent>`border-[#E9EAEB] hover:bg-[#F2F3F6] hover:border-[#BEBFC3] flex h-[40px] rounded-[12px] items-center py-[8px] pl-[12px] pr-[16px] border md:ml-[12px] cursor-pointer transition-all`
