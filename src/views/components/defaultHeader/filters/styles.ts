...
export const FiltersContainer = tw.div<TailwindComponent>`relative w-full min-w-max flex flex-col md:flex-row items-center bg-white rounded-2xl mt-9 md:mt-[48px] lg:mt-10 xl:mt-16`
