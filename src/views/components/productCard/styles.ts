...
export const DetailsWrapper = tw.div<TailwindComponent>`flex flex-col tablet:flex-row pl-5 tablet:pl-0 border-l-1 border-raisin-10 tablet:border-0 gap-5 items-center h-fit`
