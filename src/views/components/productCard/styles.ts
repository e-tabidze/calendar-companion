...
export const ProductCardContainer = tw.div<TailwindComponent>`relative max-w-[400px] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:rounded-3xl after:border after:border-transparent after:transition-all hover:after:border-raisin-100`
...
export const PreviousPrice = tw.span<TailwindComponent>`line-through text-raisin opacity-20 hidden desktop:inline`

export const Divider = tw.div`w-full h-pxdesktop:w-pxdesktop:h-8 bg-gray-90 opacity-70`
