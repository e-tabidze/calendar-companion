...
const Carousel = ({ detailSwiper, itemsArray, type, onClick, singleSlide = false, thumbs = false }: Props) => {
  ...
  return (
    <div className="relative">
      ...
      <div className={`${detailSwiper?'left-5':'left-4 md:left-0 lg:left-[-28px]'} cursor-pointer shadow-sm absolute top-1/2 -translate-y-1/2 w-[46px] h-[46px] lg:w-[56px] md:h-[56px] bg-white rounded-2xl flex items-center justify-center rotate-180 z-10`} ref={prevRef}>
