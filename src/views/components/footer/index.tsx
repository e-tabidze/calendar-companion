...
const Footer = () => {
    ...
    return (
        <footer className={`${router?.asPath?.startsWith('/details')?'pb-[142px]':'pb-20'} border-t-0 lg:border-t-1 border-raisin-10 rounded-3xl lg:rounded-none bg-white mt-10 md:mt-16 lg:pb-0 sm:px-5 lg:px-8 2xl:px-0`}>
