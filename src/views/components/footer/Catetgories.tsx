        ...
        <div className="py-[16px] lg:py-0 border-b-[1px] border-[#E9EAEB] lg:border-0">
            ...
            <div className={`${active?'block':'hidden'} lg:block`}>
                <div className="lg:flex lg:justify-between">
                    <ul className="mt-[16px] lg:mt-[24px]  max-h-[344px] overflow-hidden">
                        <li className="mb-[8px]"><a
                            className="font-normal text-[rgba(0,0,0,0.7)] text-[12px] hover:underline"
                    ...
                    <ul className="mt-[16px] lg:mt-[24px]  ">
                        <li className="mb-[8px]"><a
                            className="font-normal text-[rgba(0,0,0,0.7)] text-[12px] hover:underline"
