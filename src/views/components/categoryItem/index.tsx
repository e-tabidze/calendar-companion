...
const CategoryItem: React.FC<Props> = ({ svgPath, title, count, id }) => {
  ...
  return (
    <div className='flex group flex-col items-center cursor-pointer' onClick={() => router?.push(`/search/?category[]=${id}&page=1&free_delivery=false&sort_by=id&order_by=asc`)}>
