...
export const FiltersWrapper = tw.div<TailwindComponent>`hidden fixed z-[11] w-full border-t-1 border-b-1 border-raisin-10 top-20 lg:flex justify-between items-center py-8 bg-white px-10`
