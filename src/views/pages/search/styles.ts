...
export const SearchResultsContainer = tw.div<TailwindComponent>`flex justify-between flex-col-reverse items-baseline md:flex-row md:items-center pt-6 pb-4`
