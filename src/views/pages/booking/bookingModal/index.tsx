              ...
              >
                <Dialog.Panel className='relative transform overflow-hidden rounded-tl-3xl rounded-tr-3xl md:rounded-bl-3xl md:rounded-br-3xl bg-white text-left shadow-xl transition-all w-full md:my-4 md:max-w-3xl'>
                  <div className='w-full flex justify-between items-center px-5 md:px-10 py-4 md:py-6 sm:px-10 border-b-1 border-raisin-10 mb-6'>
                    ...
                    <Icon svgPath='close' height={40} width={40} onClick={onClose} className='flex shrink-0 cursor-pointer' />
                  </div>
                  ...
                  {/*  </Tab.Group>*/}
                  {/*</div>*/}
                  <div className='w-full flex items-center justify-between py-4 px-4 md:px-10 border-t-1 border-grey-90'>
                    <IconTextButton
                        label='გასუფთავება'
                        icon='return'
                        width={20}
                    ...
                    />
                    <div className='flex items-center justify-center bg-green-100 text-white text-2sm md:text-md rounded-xl px-6 md:px-8 h-11 md:h-14'>
                      შენახვა
                    </div>
                  </div>
                </Dialog.Panel>
