...
export const FiltersContainer = tw.div<TailwindComponent>`relative w-full max-w-[800px] flex flex-col md:flex-row items-center bg-white rounded-2xl mt-9 md:mt-[48px] lg:mt-[64px]`
