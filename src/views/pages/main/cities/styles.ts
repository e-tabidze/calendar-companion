...
export const CitiesListContainer = tw.div<TailwindComponent>`flex items-center xl:justify-between flex-col  xl:flex-row`
export const ViewAllCitiesContainer = tw.div<TailwindComponent>`max-w-xs flex items-start gap-2`
export const BenefitsContainer = tw.div<TailwindComponent>`flex gap-20 flex-col xl:flex-row`
export const CitiesWrapper = tw.div<TailwindComponent>`flex flex-wrap gap-3 justify-center xl:justify-betwen`
