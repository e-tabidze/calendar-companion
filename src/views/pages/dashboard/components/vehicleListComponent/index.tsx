...
const VehicleListComponent: React.FC = ({}) => {
  ...
  return (
    <div className='relative'>
      <div className='flex flex-col px-2 py-4 large:w-full justify-between gap-6 large:px-0 large:flex-row large:items-center'>
        <div className='flex gap-6 min-w-max'>
          ...
          <div className='min-w-max'>
            ...
            <div className='flex items-center gap-10 large:mt-10'>
        ...
        <div className='hidden large:flex gap-4'>
      ...
      <Image src='/icons/more.svg' alt='' height={13} width={3} className='absolute right-5 top-5 large:hidden' />
      <Divider />
    </div>
  )
}
